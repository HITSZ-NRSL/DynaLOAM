...
MatrixXd SCManager::makeScancontext( pcl::PointCloud<SCPointType_> & _scan_down )
{
...
void SCManager::makeAndSaveScancontextAndKeys( pcl::PointCloud<SCPointType_> & _scan_down )
{
