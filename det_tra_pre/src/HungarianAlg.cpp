...
void AssignmentProblemSolver::assignmentoptimal(assignments_t& assignment, track_t& cost,
	...
	// Memory allocation
	bool* coveredColumns = reinterpret_cast<bool*>(calloc(nOfColumns, sizeof(bool)));
	bool* coveredRows = reinterpret_cast<bool*>(calloc(nOfRows, sizeof(bool)));
	bool* starMatrix = reinterpret_cast<bool*>(calloc(nOfElements, sizeof(bool)));
	bool* primeMatrix = reinterpret_cast<bool*>(calloc(nOfElements, sizeof(bool)));
	bool* newStarMatrix = reinterpret_cast<bool*>(calloc(nOfElements, sizeof(bool))); /* used in step4 */
...
void AssignmentProblemSolver::assignmentsuboptimal1(assignments_t& assignment, track_t& cost, const distMatrix_t& distMatrixIn, size_t nOfRows, size_t nOfColumns) {
	...
	/* allocate memory */
	int* nOfValidObservations = reinterpret_cast<int *>(calloc(nOfRows, sizeof(int)));
	int* nOfValidTracks = reinterpret_cast<int *>(calloc(nOfColumns, sizeof(int)));
